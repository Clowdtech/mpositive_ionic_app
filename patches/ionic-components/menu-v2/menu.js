...
var Menu = (function () {
   ...
   * @param {?} _app
   */
  function Menu(_menuCtrl, _elementRef, _config, _plt, _renderer, _keyboard, _zone, _gestureCtrl, _domCtrl, _app) {
  ...
  Object.defineProperty(Menu.prototype, "enabled", {
     ...
     */
    set: function (val) {
      var /** @type {?} */ isEnabled = isTrueProperty(val);
